def triage_system():
    ...
    bleeding = input("Heavy Bleeding? (Y/N): ").lower() == 'y'
    high_fever = input("High Fever? (Y/N): ").lower() == 'y'
    injury = input("Recent Injury? (Y/N): ").lower() == 'y'
    dizziness = input("Dizziness or Fainting? (Y/N): ").lower() == 'y'
    stomach_pain = input("Severe Stomach Pain? (Y/N): ").lower() == 'y'
